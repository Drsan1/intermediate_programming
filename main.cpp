...
int hamming(Vector5 a, Vector5 b) {
    int x_sum = abs(a.x - b.x);
    int y_sum = abs(a.y - b.y);
    int z_sum = abs(a.z - b.z);
    int w_sum = abs(a.w - b.w);
    int v_sum = abs(a.v - b.v);
...
int main() {
    ...
    int _hamming = hamming(vec1, vec2);
    ...
    std::cout << "Hamming: " << _hamming << std::endl;
}